...
//        return 0;
//    }
    string netlistFile = string("../src/circuits/")+string(argv[1]);//use these 2 lines for command line, other 2 for debugger 1.
    ...
    string verilogFile = string("../src/circuits/")+string(argv[2]);//2.
